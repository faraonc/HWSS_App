    ...
    methods: {
        ...
        beginSearch: function beginSearch() {
            ...
            for (var i in this.selectedCategories) {
                var name = this.selectedCategories[i].name.charAt(0).toLowerCase() + this.selectedCategories[i].name.slice(1).replace(' ', '');
